...
var api = {
    ...
    put: function (isOnlyParams) {
        return function (req, res, next) {
            ...
            var params = {
                acceptable: ['LGD_OID', 'LGD_CARDACQUIRER', 'LGD_IFOS', 'LGD_MID', 'LGD_FINANCENAME', 'LGD_PCANCELFLAG', 'LGD_FINANCEAUTHNUM', 'LGD_DELIVERYINFO', 'LGD_AFFILIATECODE', 'LGD_TRANSAMOUNT', 'LGD_BUYERID', 'LGD_CARDNUM', 'LGD_RECEIVERPHONE', 'LGD_2TR_FLAG', 'LGD_DEVICE', 'LGD_TID', 'LGD_FINANCECODE', 'LGD_CARDNOINTYN', 'LGD_CARDNOINTEREST_YN', 'LGD_PCANCELSTR', 'LGD_IDPKEY', 'LGD_BUYERPHONE', 'LGD_ESCROWYN', 'LGD_PAYTYPE', 'LGD_VANCODE', 'LGD_EXCHANGERATE', 'LGD_BUYERSSN', 'LGD_CARDINSTALLMONTH', 'LGD_PAYDATE', 'LGD_PRODUCTCODE', 'LGD_HASHDATA', 'LGD_CARDGUBUN1', 'LGD_CARDGUBUN2', 'LGD_BUYERADDRESS', 'LGD_RECEIVER', 'LGD_RESPCODE', 'LGD_RESPMSG','LGD_CARDNOINTEREST_YN','LGD_DISCOUNTUSEYN','LGD_ISPKEY','LGD_DISCOUNTUSEAMOUNT', 'LGD_AMOUNT', 'LGD_BUYER', 'LGD_PRODUCTINFO', 'LGD_TIMESTAMP'],
                essential: ['LGD_OID'],
                resettable: [],
                explains: {
                    'LGD_OID': '수정할 신고 내용'
